...
export class Authentication {
  ...
  /**
   * Generates a verification email link for the provided email address.
   ...
   * @returns {Promise<string>} - A promise resolving to the verification request.
   */
  ...
  /**
   * Verifies phone number verification.
   * @param {string} verificationId - The verification ID.
   * @param {string} otp - The one-time passcode.
   * @returns {Promise<object>} - A promise resolving to the user credentials.
   */
   ...
   * @returns {Promise<object[]>} - A promise resolving to an array of user objects.
   */
  async getUsers() {

...
export default class Firestore {
   ...
   * @param {string[]} nestedPaths - Array of nested paths within the collection.
   */
  ...
  async create(data) {
    ...
    // Traverse nested paths and create collection references
  ...
  /**
   * Read all documents from the Firestore collection.
